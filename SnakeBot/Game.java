public class Game {
    ...
    public static final AI FIRST = new SampleAI1(1); // Replace constructor with Player1's AI
    public static final AI SECCOND = new SampleAI2(2); // Replace constructor with Player2's AI
